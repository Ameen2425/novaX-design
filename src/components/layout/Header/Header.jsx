    ...
    <>
      ...
      <header className="mobile-top-brand">
        ...
        <div className="mobile-top-actions">
          ...
          <NavLink to="/deals" className="mobile-action-btn mobile-deals-pulse" title="Special Deals">
      ...
      <header className="header desktop-header">
        ...
        <div className="header-actions">
          <div className="header-icon-group">
            ...
            <NavLink to="/deals" className={({ isActive }) => isActive ? "header-action-btn deals-shortcut active" : "header-action-btn deals-shortcut"} title="Special Deals">
